          ...
          <div>
            ...
            <div className="mt-6 text-sm text-white/70 flex items-center gap-3">
              <span className="inline-flex items-center gap-2 px-2.5 py-1 rounded-lg bg-emerald-500/10 border border-emerald-400/30 text-emerald-300">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" className="opacity-80"><path d="M9 12l2 2 4-4" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg> 30-day money-back guarantee
              </span>
              <span><span className="font-semibold text-white">$1,000/month</span> · One flat fee. One signed client pays for it 10× over.</span>
            </div>
          </div>
      ...
      <section id="pricing" className="max-w-6xl mx-auto px-4 py-16">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-8 grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-2 text-white/80">$1,000/month. No contracts. Cancel anytime. One extra client pays for it 10× over.</p>
      ...
      <section id="faq" className="max-w-6xl mx-auto px-4 pb-24">
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-6">
          <div className="rounded-3xl border border-white/10 p-6 bg-white/5">
            <h3 className="font-semibold">What exactly do I get for $1,000/month?</h3>
          ...
          <div className="rounded-3xl border border-emerald-400/30 p-6 bg-emerald-500/5">
      ...
      <section className="max-w-6xl mx-auto px-4 pb-20">
        <div className="rounded-3xl border border-white/10 bg-white/5 p-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 opacity-80">
            ...
            <span className="bg-neutral-900 border
